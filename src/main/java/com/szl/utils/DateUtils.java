...
//	public static final SimpleDateFormat formatTimestamp = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	 ...
	 */
	public static long getYearByIdCard(String id_card){
		String dateStr = null;
		try{
			dateStr = DateUtils.toString(DateUtils.parseDate(id_card.substring(6,14), "yyyyMMdd"), "yyyy-MM-dd HH:mm:ss");
			String currentTime = DateUtils.currentTime();
			return DateUtils.getDateDiff(dateStr,currentTime)/365;
...
//		return parseDate(str, new String[] { parsePatterns });
	...
	public static String getSysDateTimeString() {
		return toString(new java.util.Date(System.currentTimeMillis()), new SimpleDateFormat(DateUtils.DATE_FORMAT_DATETIME));
	}
	...
	public static boolean isInBetweenTimes(String startTime, String endTime) {
		...
		SimpleDateFormat sdf = new SimpleDateFormat(TIME_WITH_MINUTE_PATTERN);
   ...
   /**
    * 转换时间将2015-02-04 14:50:18型转为20150204145018
    * @param time
    * @return
    */
